...
export class CategoryServiceProxy {
     ...
     * @return Success
     */
    getAll(filterText: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetCategoryForViewDtoPagedResultDto> {
    ...
    protected processGetAll(response: HttpResponseBase): Observable<GetCategoryForViewDtoPagedResultDto> {
        ...
        return _observableOf<GetCategoryForViewDtoPagedResultDto>(null as any);
    }

    /**
     * @return Success
     */
    getAllForCreateItem(): Observable<GetCategoryForViewDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Category/GetAllForCreateItem";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetCategoryForViewDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetCategoryForViewDto[]>;
        }));
    }

    protected processGetAllForCreateItem(response: HttpResponseBase): Observable<GetCategoryForViewDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return _observableOf<GetCategoryForViewDto[]>(null as any);
    }
...
export class ItemServiceProxy {
     ...
     * @return Success
     */
    getAll(filterText: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetItemForViewDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetItemForViewDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetItemForViewDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<GetItemForViewDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetItemForViewDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetItemForViewDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    createOrEdit(body: CreateOrEditItemDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Item/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
...
export class GetItemForViewDto implements IGetItemForViewDto {
    ...
    static fromJS(data: any): GetItemForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetItemForViewDto();
        result.init(data);
        return result;
    }
...
export class GetItemForViewDtoPagedResultDto implements IGetItemForViewDtoPagedResultDto {
    items: GetItemForViewDto[] | undefined;
    totalCount: number;

    constructor(data?: IGetItemForViewDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(GetItemForViewDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): GetItemForViewDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetItemForViewDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetItemForViewDtoPagedResultDto {
        const json = this.toJSON();
        let result = new GetItemForViewDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetItemForViewDtoPagedResultDto {
    items: GetItemForViewDto[] | undefined;
    totalCount: number;
}
